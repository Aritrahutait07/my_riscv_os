...
os.elf: src/asm/boot.S src/asm/trap.S src/kernel.c src/uart/uart.c src/init/shell/shell.c src/mm/pages/page.c
	$(CC) $(CFLAGS) -Tsrc/lds/virt.lds src/asm/boot.S src/asm/trap.S src/kernel.c src/uart/uart.c src/init/shell/shell.c src/mm/pages/page.c src/trap/trap.c -o os.elf
